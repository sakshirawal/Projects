...
<div class="container" style="min-height:395px;width:95%;margin-top:-15px;">
    ...
    <div class="col-9" style="width:20%;">
     <div class="list-group">
		<ul type="none">
			...
			<li><a href="bus.php" target="_self" class="mudit">Bus</a></li>
 ...
 <ul type="none">
 	<center>
 	<li><a href="bus_timings.pdf" target="_blank">Bus Timings</a></li><br>
 	<li><a href="https://docs.google.com/forms/d/1cCJklVZFXfTSNpigSBgCbHow7ynNSl15T7TnI3z4nkw/viewform?usp=send_form" target="_blank">Bus Complaint</a></li><br></center>
 </ul>
</div>
 </div>
 </div>
