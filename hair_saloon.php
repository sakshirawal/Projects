...
<div class="container" style="min-height:395px;width:95%;margin-top:-15px;">
 ...
 <b>
 <ul type="none">
  <center><h3>HAIR SALOON:</h3><br><li>
  <li><a href="sample.pdf" target="_blank">Price List</a></li><br>
  <li><a href="sample.pdf" target="_blank">Feedback Form</a></li><br>
  <li><a href="sample.pdf" target="_blank">Contact Details</a></li><br>
</center>
 </ul>
</div>
 </div>
